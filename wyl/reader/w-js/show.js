...
var P7ssma,p7ssmfrst,p7sscur=-1,p7ssmmode='auto',p7ssmtimer,p7ssmbusy=false,p7ssmsobj,p7ofX,p7ofY,p7ssmspd,p7ssmMinSpeed=2,p7ssmMaxSpeed=5;
...
function P7_SSMdisplay(){
	...
	cf.innerHTML='<im'+'g sr'+'c="'+document.p7sspre[x].src+'" width=220 heigth=300>';
	if(fsc.p7hssz){
